...
S = "/start"
START_PIC = "https://graph.org/file/9b9ca2120aa4c486484ec.png"
TEXT = "Send me the Link of any message of Restricted Channels to Clone it here.\nFor private channel's messages, send the Invite Link first.\n\n👉🏻 Execute /batch for bulk process upto 10K files range by Dhrubo."
...
async def youtube_dl_command(_, message):
    ...
    if len(message.command) > 1:
        ...
        try:
            ...
            caption = f"{video_info['title']}\n\n__**Powered by [Dhrubo](https://t.me/dhrubodbo01)**__"  # Set caption to the title of the video
